  ...
  <body>
    ...
    <br>
      ...
      <ul class="nav justify-content-center" id="nav_catelog" data-aos="fade-up" style="margin-bottom:5px;">
        ...
        <li class="nav-item">
          <a class="nav-link disabled"  href="./vitamins.php">Vitamins</a>
        </li>
        <li class="nav-item">
      ...
      <div class="container mx-auto text-center" id="products">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="product-box">
              <img src="./Drawables/fishoil.png" class="product-img">
              <h2 class="product-title">ON FISH OIL 100CAP</h2>
              <span class="product-price">LKR 2500.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
              <p style="padding:0%; color: black;">Rating : 5 From 1400 views</p>
          ...
          <div class="col-md-4">
            <div class="product-box">
              <img src="./Drawables/rsp-tribulus.jpg" class="product-img">
              <h2 class="product-title">RSP TRIBULUS</h2>
              <span class="product-price">LKR 8000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
              <p style="padding:0%; color: black;">Rating : 4.5 From 920 views</p>
              <P style="padding:0%; color: #FEB142;">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
          ...
          <div class="col-md-4">
            ...
            <div class="product-box">
              <img src="./Drawables/OIP-8.jpg" class="product-img">
              <h2 class="product-title">GAT ZMAG-T</h2>
              <span class="product-price">LKR 3000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
        ...
        <div class="row">
          ...
          <div class="col-md-4"data-aos="fade-up">
            ...
            <div class="product-box">
              <img src="./Drawables/b12-2500-mcg.jpg" class="product-img">
              <h2 class="product-title">B-12 2500</h2>
              <span class="product-price">LKR 8000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
          ...
          <div class="col-md-4"data-aos="fade-up">
            <div class="product-box">
              <img src="./Drawables/super-b-complex.jpg" class="product-img">
              <h2 class="product-title">SUPER B-COMPLEX</h2>
              <span class="product-price">LKR 12000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
          ...
          <div class="col-md-4"data-aos="fade-up">
            ...
            <div class="product-box">
              <img src="./Drawables/omega.jpg" class="product-img">
              <h2 class="product-title">PLATINUM FISH OIL 100CAP</h2>
              <span class="product-price">LKR 3000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
        ...
        <div class="row">
          ...
          <div class="col-md-4"data-aos="fade-up">
            ...
            <div class="product-box">
              ...
              <span class="product-price">LKR 6000</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
          ...
          <div class="col-md-4"data-aos="fade-up">
            <div class="product-box">
              <img src="./Drawables/adult-multivitamin-gummies-1.jpg" class="product-img">
              <h2 class="product-title">MULTI-VITAMIN</h2>
          ...
          <div class="col-md-4"data-aos="fade-up">
            ...
            <div class="product-box">
              <img src="./Drawables/animal.jpg" class="product-img">
              <h2 class="product-title">ANIMAL PAK</h2>
              <span class="product-price">LKR 11000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>

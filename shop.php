  ...
  <body>
    ...
    <br>
      ...
      <ul class="nav justify-content-center" id="nav_catelog" data-aos="fade-up" style="margin-bottom:5px;">
        <li class="nav-item">
          <a class="nav-link disabled" href="./shop.php">Supplements</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="active" href="./accecories.php">Accecories</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="active" href="./foods.php">Foods & Snaks</a>
        </li>
        <li class="nav-item">
      ...
      <h3 class="topics"> Supplements </h3>
      ...
      <div class="container mx-auto text-center" id="products">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="product-box">
              <img src="./Drawables/best-protein-1.jpg" class="product-img">
              <h2 class="product-title">BEST PROTEINE</h2>
              <span class="product-price">LKR 15000.00</span>
          ...
          <div class="col-md-4">
            <div class="product-box">
              <img src="./Drawables/CARNIVOR-MASS-6.jpg" class="product-img">
              <h2 class="product-title">CARNIVOR MASS 10LBS</h2>
              <span class="product-price">LKR 28000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
          ...
          <div class="col-md-4">
            ...
            <div class="product-box">
              <img src="./Drawables/combat.jpg" class="product-img">
              <h2 class="product-title">COMBAT PROTINE 4LBS</h2>
              <span class="product-price">LKR 20000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
              <p style="padding:0%; color: black;">Rating : 4.7 From 3000 views</p>
              <P style="padding:0%; color: #FEB142;">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
        ...
        <div class="row">
          ...
          <div class="col-md-4"data-aos="fade-up">
            ...
            <div class="product-box">
              <img src="./Drawables/nitro.png" class="product-img">
              <h2 class="product-title">NITRO TECH</h2>
              <span class="product-price">LKR 26000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
          ...
          <div class="col-md-4"data-aos="fade-up">
            <div class="product-box">
              <img src="./Drawables/bcaa.jpg" class="product-img">
              <h2 class="product-title">BCAA</h2>
              <span class="product-price">LKR 10500.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
          ...
          <div class="col-md-4"data-aos="fade-up">
            ...
            <div class="product-box">
              <img src="./Drawables/Essentials_Glutamine_60serve.jpg" class="product-img">
              <h2 class="product-title">MP GLUTAMINE</h2>
              <span class="product-price">LKR 4000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
        ...
        <div class="row">
          ...
          <div class="col-md-4"data-aos="fade-up">
            ...
            <div class="product-box">
              <img src="./Drawables/creatine.jpg" class="product-img">
              <h2 class="product-title">CREATINE</h2>
              <span class="product-price">LKR 6000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
          ...
          <div class="col-md-4"data-aos="fade-up">
            <div class="product-box">
              <img src="./Drawables/rsp-whey-5lb.jpg" class="product-img">
              <h2 class="product-title">RSP WHEY PROTEINE 4.6LBS</h2>
              <span class="product-price">LKR 26000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
          ...
          <div class="col-md-4"data-aos="fade-up">
            ...
            <div class="product-box">
              <img src="./Drawables/cat.jpg" class="product-img">
              <h2 class="product-title">GAT NITRAFLEX PRE 30SEV</h2>
              <span class="product-price">LKR 11000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
        ...
        <div class="row">
          ...
          <div class="col-md-4"data-aos="fade-up">
            ...
            <div class="product-box">
              <img src="./Drawables/c4-30.jpg" class="product-img">
              <h2 class="product-title">C4 ORIGINAL 30SEVE</h2>
              <span class="product-price">LKR 11000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
              <p style="padding:0%;  color: black;">Rating : 4 From 2000 views</p>
              <P style="padding:0%; color: #FEB142;">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
          ...
          <div class="col-md-4"data-aos="fade-up">
            <div class="product-box">
              <img src="./Drawables/psy.jpg" class="product-img">
              <h2 class="product-title">PSYCHOTIC PRE</h2>
              <span class="product-price">LKR 10000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
              <p style="padding:0%; color: black;">Rating : 4.5 From 500 views</p>
              <P style="padding:0%; color: #FEB142;">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
          ...
          <div class="col-md-4"data-aos="fade-up">
            ...
            <div class="product-box">
              <img src="./Drawables/OIP-5.jpg" class="product-img">
              <h2 class="product-title">THE SHADOW PRE</h2>
              <span class="product-price">LKR 11000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
              <p style="padding:0%; color: black;">Rating : 4.5 From 2000 views</p>
              <P style="padding:0%; color: #FEB142;">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
      ...
      function buyBtnClick(){
        ...
        swal({
               ...
               button: "OK",
                  ...
                  var valueT = 1000.00;
                  localStorage.setItem('values',valueT);

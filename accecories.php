  ...
  <body>
    ...
    <br>
      ...
      <ul class="nav justify-content-center" id="nav_catelog" data-aos="fade-up" style="margin-bottom:5px;">
        ...
        <li class="nav-item">
          <a class="nav-link disabled"  href="././accecories.php">Accecories</a>
        </li>
        <li class="nav-item">
      ...
      <h3 class="topics"> Clothing & Accecories </h3>
      ...
      <div class="container mx-auto text-center" id="products">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="product-box">
              <img src="./Drawables/KT-Tape-Original.jpg" class="product-img">
              <h2 class="product-title">KT TAPE</h2>
          ...
          <div class="col-md-4">
            <div class="product-box">
              <img src="./Drawables/Blender-Bottle-Shaker-Bottle-1Liter.jpg" class="product-img">
              <h2 class="product-title">BLENDER BOTTLE</h2>
          ...
          <div class="col-md-4">
            ...
            <div class="product-box">
              <img src="./Drawables/321-STRONG-Foam-Roller.jpg" class="product-img">
              <h2 class="product-title">321 STRONG</h2>
              <span class="product-price">LKR 10000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
              <p style="padding:0%; color: black;">Rating : 4.7 From 2000 views</p>
              <P style="padding:0%; color: #FEB142;">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
        ...
        <div class="row">
          ...
          <div class="col-md-4"data-aos="fade-up">
            ...
            <div class="product-box">
              <img src="./Drawables/arm-blaster.jpg" class="product-img">
              <h2 class="product-title">ARM BLASTER</h2>
          ...
          <div class="col-md-4"data-aos="fade-up">
            <div class="product-box">
              <img src="./Drawables/Blender-Bottle-Shaker-Bottle.jpg" class="product-img">
              <h2 class="product-title">BLENDER-BOTTLE</h2>
              <span class="product-price">LKR 10500</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>
              <p style="padding:0%; color: black; ">Rating : 4.5 From 1600 views</p>
              <P style="padding:0%; color: #FEB142;">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
          ...
          <div class="col-md-4"data-aos="fade-up">
            ...
            <div class="product-box">
              <img src="./Drawables/mp-shaker.jpg" class="product-img">
              <h2 class="product-title">MP SHAKER</h2>
              <span class="product-price">LKR 2000.00</span>
              <p style="color:yellowgreen; font-size:15px; padding: 0%;"> - In stock - </p>

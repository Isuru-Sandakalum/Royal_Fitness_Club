...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link" id="nav_active" href="./gallery.php">Gallery<span class="sr-only">(current)</span></a>
              </li>
    ...
    <h2 class="topics">Pay your bill</h2>
    <p style="text-align:center ;">Fill below fields to submit your payment</p>
    ...
    <div class="container" id="payment">
      ...
      <form action="">
        ...
        <div class="row" style="padding:10px;">
          ...
          <div class="row">
              ...
              <div class="col">
                  ...
                  <div class="flex">
                      <div class="inputBox">
                          <span>District :</span>
                          <input type="text" placeholder="Ex:puttlam">
                      </div>
                      <div class="inputBox">
                          <span>Postal code :</span>
                          <input type="text" placeholder="61000">
                      </div>
                  </div>
              ...
              <div class="col">
                  ...
                  <div class="inputBox">
                      ...
                      <img src="./Drawables/card_img.png" alt="">
                  </div>
                  <div class="inputBox">
                      <span>name on card :</span>
                      <input type="text" placeholder="Mr. isuru sandakalum">
                  </div>
                  <div class="inputBox">
          ...
          <button type="button" class="submit-btn" onclick="submitBtnClick()"> proceed to checkout </button>
  ...
  <footer class="footer"  data-aos="fade-up">
   ...
   <script>
      var tValue = localStorage.getItem('values');
      document.getElementById('payment_value').innerHTML = "LKR"+" " + tValue; 
      function submitBtnClick(){
        swal({
               title: "Done",
               text: "Your transaction proceeded",
               icon: "success",
               button: "OK",
